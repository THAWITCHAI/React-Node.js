    ...
    <section id="sidebar">
      <div className="side-pmr">
        ...
        <Link to="/wait" className="item">
          ...
          <div className="text text-truncate">กำลังดำเนินการ...</div>
        </Link>

        <Link to="/Finish" className="item">
          <div className="icon">
            <img
              src="https://cdn-icons-png.flaticon.com/128/2782/2782895.png"
              alt=""
              width={24}
              height={24}
            />
        ...
        <Link to="/AddTables" className="item">
          <div className="icon">
            <img
              src="https://cdn-icons-png.flaticon.com/128/1237/1237747.png"
              alt=""
              width={24}
              height={24}
            />
        ...
        <Link to="/contact" className="item">
          <div className="icon">
            <img
              src="https://cdn-icons-png.flaticon.com/128/1602/1602309.png"
              alt=""
              width={24}
              height={24}
            />
        ...
        <Link to="/login" className="item" onClick={Log_out}>
          <div className="icon">
            <img
